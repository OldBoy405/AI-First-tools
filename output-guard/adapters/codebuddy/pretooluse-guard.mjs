#!/usr/bin/env node
// CodeBuddy Code PreToolUse hook → OutputGuard Core 映射（CR-2026-069 TASK-04，SDD §3.3）。
//
...
export async function handle(payload) {
  ...
  try {
    ...
    if (decision.action === 'rewrite') {
      return { ok: true, out: { hookSpecificOutput: { hookEventName: 'PreToolUse', permissionDecision: 'allow', modifiedInput: decision.rewrittenInput } } };
    }
